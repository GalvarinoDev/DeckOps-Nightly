-- DeckOps Community - MP Main Menu Mod (v2 - simplified)
-- Adds community server connect, unlock all, and reset stats
...
CoD.DeckOps.ConnectMP = function(MainLobbyWidget, ClientInstance)
	Engine.Exec(ClientInstance.controller, "connect 207.244.231.63:4976")
end
...
CoD.DeckOps.ResetStats = function(MainLobbyWidget, ClientInstance)
	Engine.Exec(ClientInstance.controller, "resetStats")
end

-- ============================================================
-- Standard MainLobby functions (base game)
-- ============================================================
...
-- ============================================================
-- Button Population - MP
-- Keeps all original buttons, adds DeckOps buttons after Barracks
-- ============================================================

CoD.MainLobby.PopulateButtons_Multiplayer = function(MainLobbyButtonPane)
	-- Server Browser (Plutonium built-in)
	...
	-- DeckOps Community Server
	MainLobbyButtonPane.body.deckopsConnectButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("DECKOPS SERVER"), nil, 2)
	MainLobbyButtonPane.body.deckopsConnectButton.hintText = "Connect to DeckOps BO2 Multiplayer"
	MainLobbyButtonPane.body.deckopsConnectButton:setActionEventName("deckops_connect_mp")
	...
	-- Unlock All
	MainLobbyButtonPane.body.unlockAllButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("UNLOCK ALL"), nil, 8)
	...
	-- Reset Stats
	MainLobbyButtonPane.body.resetStatsButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("RESET STATS"), nil, 9)
	...
	if CoD.isZombie == false and not Engine.IsBetaBuild() and (CoD.isXBOX or CoD.isPS3) and Engine.IsEliteAvailable() and Engine.IsEliteButtonAvailable() then
		MainLobbyButtonPane.body.eliteAppButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_ELITE_CAPS"), nil, 10)
	...
	MainLobbyButtonPane.body.buttonList:addSpacer(CoD.CoD9Button.Height / 2, 11)

	-- Options
	MainLobbyButtonPane.body.optionsButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_OPTIONS_CAPS"), nil, 12)
	...
	-- Mods
	MainLobbyButtonPane.body.modsButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MODS"), nil, 13)
...
LUI.createMenu.MainLobby = function(LocalClientIndex)
	...
	MainLobbyWidget:registerEventHandler("deckops_connect_mp", CoD.DeckOps.ConnectMP)
	MainLobbyWidget:registerEventHandler("deckops_unlock_all", CoD.DeckOps.UnlockAll)
	MainLobbyWidget:registerEventHandler("deckops_reset_stats", CoD.DeckOps.ResetStats)
